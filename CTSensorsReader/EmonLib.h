...
#define CTSENSORSREADER_CLEANUP 1
...
class EnergyMonitor
{
  public:
    ...
    double calcIrms(unsigned int Number_of_Samples, long readVccCalib);
    //void serialprint();

    long readVcc(long readVccCalib);
  ...
  private:
    ...
    double sumI;
    //double instP;
    //double sumP;         //sq = squared, sum = Sum, inst = instantaneous
